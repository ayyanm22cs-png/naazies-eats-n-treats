...
export default function ComingSoon() {
    ...
    const handleWhatsApp = () => {
        const message = 'Hi! I saw your coming soon page and wanted to inquire about your Pure Veg cakes.';
            ...
            <div className="max-w-3xl w-full relative z-10 text-center">
                ...
                >
                    <div className="relative">
                        <div className="w-24 h-24 md:w-32 md:h-32 bg-[#1A1A1A] border border-[#D4AF37]/20 rounded-3xl flex items-center justify-center mx-auto shadow-2xl relative z-10">
                            <UtensilsCrossed className="h-12 w-12 md:h-16 md:w-16 text-[#D4AF37]" aria-hidden="true" />
                        </div>
                ...
                >
                    <span className="text-[#D4AF37] text-xs md:text-sm tracking-[0.4em] uppercase font-bold">
                        Something Sweet is Brewing in Mumbai
                    </span>
                    ...
                    <p className="text-gray-400 text-lg md:text-xl max-w-xl mx-auto leading-relaxed">
                        We are currently fine-tuning this page to bring you the best <strong>homemade cake experience</strong>.
                        Our digital bakery is almost ready to serve the finest <strong>100% Pure Veg treats</strong>!
                    </p>
                </motion.div>
                ...
                >
                    ...
                    <Button
                        ...
                        aria-label="Inquire about Veg cakes via WhatsApp"
                ...
                >
                    ...
                    <a
                        ...
                        aria-label="Follow Naazie's Eats & Treats on Instagram"
